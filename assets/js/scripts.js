...
! function(e, t, a) {
  var l, n, s, i, o, r, c, u, h, g, f, d = "mPageScroll2id",
    p = "mPS2id",
    _ = ".m_PageScroll2id,a[rel~='m_PageScroll2id'],.page-scroll-to-id,a[rel~='page-scroll-to-id'],._ps2id",
    C = { scrollSpeed: 1300, autoScrollSpeed: !0, scrollEasing: "easeInOutExpo", scrollingEasing: "easeInOutCirc", pageEndSmoothScroll: !0, layout: "vertical", offset: 0, highlightSelector: !1, clickedClass: p + "-clicked", targetClass: p + "-target", highlightClass: p + "-highlight", forceSingleHighlight: !1, keepHighlightUntilNext: !1, highlightByNextTarget: !1, disablePluginBelow: !1, clickEvents: !0, onStart: function() {}, onComplete: function() {}, defaultSelector: !1, live: !0, liveSelector: !1 },
    v = 0,
    m = {
      init: function(r) {
        var r = e.extend(!0, {}, C, r);
        if (e(a).data(p, r), n = e(a).data(p), !this.selector) {
          var c = "__" + p;
          this.each(function() {
            var t = e(this);
        ...
        n.liveSelector && (this.selector += "," + n.liveSelector), l = l ? l + "," + this.selector : this.selector, n.defaultSelector && ("object" == typeof e(l) && 0 !== e(l).length || (l = _)), n.clickEvents && e(a).undelegate("." + p).delegate(l, "click." + p, function(t) {
          if (S._isDisabled.call(null)) return void S._removeClasses.call(null);
          var a = e(this),
            l = a.attr("href"),
            n = a.prop("href");
          l && -1 !== l.indexOf("#/") || (S._reset.call(null), g = a.data("ps2id-offset") || 0, S._isValid.call(null, l, n) && S._findTarget.call(null, l) && (t.preventDefault(), i = "selector", o = a, S._setClasses.call(null, !0), S._scrollTo.call(null)))
        }), e(t).unbind("." + p).bind("scroll." + p + " resize." + p, function() {
          if (S._isDisabled.call(null)) return void S._removeClasses.call(null);
          var t = e("._" + p + "-t");
          t.each(function(a) {
            var l = e(this),
              n = l.attr("id"),
              s = S._findHighlight.call(null, n);
            S._setClasses.call(null, !1, l, s), a == t.length - 1 && S._extendClasses.call(null)
          })
      ...
      destroy: function() { e(t).unbind("." + p), e(a).undelegate("." + p).removeData(p), e("._" + p + "-t").removeData(p), S._removeClasses.call(null, !0) }
    },
    S = {
      ...
      _setup: function() {
        ...
        return e(t).each(function() {
          var s = e(this),
            i = s.attr("href"),
            o = s.prop("href");
          if (S._isValid.call(null, i, o)) {
            var r = -1 !== i.indexOf("#/") ? i.split("#/")[1] : i.split("#")[1],
              c = e("#" + r);
            if (c.length > 0) {
              n.highlightByNextTarget && c !== l && (l ? l.data(p, { tn: c }) : c.data(p, { tn: "0" }), l = c), c.hasClass("_" + p + "-t") || c.addClass("_" + p + "-t"), c.data(p, { i: a }), s.hasClass("_" + p + "-h") || s.addClass("_" + p + "-h");
              var u = S._findHighlight.call(null, r);
              S._setClasses.call(null, !1, c, u), v = a, a++, a == e(t).length && S._extendClasses.call(null)
            }
          }
        })
      },
      _highlightSelector: function() { return n.highlightSelector && "" !== n.highlightSelector ? n.highlightSelector : l },
      _findTarget: function(t) {
        ...
        return r = l, u || (u = n.layout), h = S._setOffset.call(null), c = [(l.offset().top - h[0]).toString(), (l.offset().left - h[1]).toString()], c[0] = c[0] < 0 ? 0 : c[0], c[1] = c[1] < 0 ? 0 : c[1], c
      },
      _setOffset: function() {
      ...
      _findHighlight: function(a) {
        var l = t.location.toString().split("#")[0],
          n = e("._" + p + "-h[href='#" + a + "']"),
          s = e("._" + p + "-h[href='" + l + "#" + a + "']"),
          i = e("._" + p + "-h[href='#/" + a + "']"),
          o = e("._" + p + "-h[href='" + l + "#/" + a + "']");
      ...
      _setClasses: function(t, a, l) {
        var s = n.clickedClass,
          i = n.targetClass,
          r = n.highlightClass;
        t && s && "" !== s ? (e("." + s).removeClass(s), o.addClass(s)) : a && i && "" !== i && l && r && "" !== r && (S._currentTarget.call(null, a) ? (a.addClass(i), l.addClass(r)) : (!n.keepHighlightUntilNext || e("." + r).length > 1) && (a.removeClass(i), l.removeClass(r)))
      },
      _extendClasses: function() {
        var t = n.targetClass,
          ...
          r = a + "-first",
          c = a + "-last";
        e("._" + p + "-t").removeClass(i + " " + o), e("._" + p + "-h").removeClass(r + " " + c), n.forceSingleHighlight ? n.keepHighlightUntilNext && l.length > 1 ? (l.slice(0, 1).removeClass(t), s.slice(0, 1).removeClass(a)) : (l.slice(1).removeClass(t), s.slice(1).removeClass(a)) : (l.slice(0, 1).addClass(i).end().slice(-1).addClass(o), s.slice(0, 1).addClass(r).end().slice(-1).addClass(c))
      },
      _removeClasses: function(t) { e("." + n.clickedClass).removeClass(n.clickedClass), e("." + n.targetClass).removeClass(n.targetClass + " " + n.targetClass + "-first " + n.targetClass + "-last"), e("." + n.highlightClass).removeClass(n.highlightClass + " " + n.highlightClass + "-first " + n.highlightClass + "-last"), t && (e("._" + p + "-t").removeClass("_" + p + "-t"), e("._" + p + "-h").removeClass("_" + p + "-h")) },
      _currentTarget: function(a) {
        var l = n["target_" + a.data(p).i],
          s = a.data("ps2id-target"),
          i = s ? e(s)[0].getBoundingClientRect() : a[0].getBoundingClientRect();
        ...
        if (n.highlightByNextTarget) { var w = a.data(p).tn; if (w) { var y = w[0].getBoundingClientRect(); "vertical" === n.layout ? b = [i.top <= f / 2, y.top > f / 2, 1, 1] : "horizontal" === n.layout && (b = [1, 1, i.left <= d / 2, y.left > d / 2]) } }
        return b[0] && b[1] && b[2] && b[3]
      },
      _scrollTo: function() {
        n.scrollSpeed = parseInt(n.scrollSpeed), c = n.pageEndSmoothScroll ? S._pageEndSmoothScroll.call(null) : c;
        var a = e("html,body"),
          l = n.autoScrollSpeed ? S._autoScrollSpeed.call(null) : n.scrollSpeed,
          s = a.is(":animated") ? n.scrollingEasing : n.scrollEasing,
          i = e(t).scrollTop(),
          o = e(t).scrollLeft();
        switch (u) {
          case "horizontal":
            o != c[1] && (S._callbacks.call(null, "onStart"), a.stop().animate({ scrollLeft: c[1] }, l, s).promise().then(function() { S._callbacks.call(null, "onComplete") }));
            break;
          case "auto":
            if (i != c[0] || o != c[1])
              if (S._callbacks.call(null, "onStart"), navigator.userAgent.match(/(iPod|iPhone|iPad|Android)/)) {
                var r;
                a.stop().animate({ pageYOffset: c[0], pageXOffset: c[1] }, { duration: l, easing: s, step: function(e, a) { "pageXOffset" == a.prop ? r = e : "pageYOffset" == a.prop && t.scrollTo(r, e) } }).promise().then(function() { S._callbacks.call(null, "onComplete") })
              } else a.stop().animate({ scrollTop: c[0], scrollLeft: c[1] }, l, s).promise().then(function() { S._callbacks.call(null, "onComplete") });
            break;
          default:
            i != c[0] && (S._callbacks.call(null, "onStart"), a.stop().animate({ scrollTop: c[0] }, l, s).promise().then(function() { S._callbacks.call(null, "onComplete") }))
        }
      },
      ...
      _autoScrollSpeed: function() {
        var l = e(t).scrollTop(),
          ...
          i = e(a).height(),
          o = e(a).width(),
          r = [n.scrollSpeed + n.scrollSpeed * Math.floor(Math.abs(c[0] - l) / i * 100) / 100, n.scrollSpeed + n.scrollSpeed * Math.floor(Math.abs(c[1] - s) / o * 100) / 100];
        return Math.max.apply(Math, r)
      },
      _callbacks: function(e) {
        if (n) switch (this[p] = { trigger: i, clicked: o, target: r, scrollTo: { y: c[0], x: c[1] } }, e) {
          case "onStart":
            n.onStart.call(null, this[p]);
            break;
          case "onComplete":
            n.onComplete.call(null, this[p])
        }
      },
      _reset: function() { u = h = g = !1 },
      _isInit: function() { s || m.init.apply(this) },
      _live: function() { f = setTimeout(function() { n.live ? e(S._highlightSelector()).length !== v && S._setup.call(null) : f && clearTimeout(f), S._live.call(null) }, 1e3) },
      _easing: function() {
        function t(e) {
          var t = 7.5625,
            a = 2.75;
  ...
  S._easing.call(), e.fn[d] = function(t) { return m[t] ? m[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist") : m.init.apply(this, arguments) }, e[d] = function(t) { return m[t] ? m[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist") : m.init.apply(this, arguments) }, e[d].defaults = C
