...
define( 'WP_HOME', 'https://massagecourse.com.ua/' );
define( 'WP_SITEURL', 'https://massagecourse.com.ua/' );
if (strpos($_SERVER['HTTP_X_FORWARDED_PROTO'], 'https') !== false)
       $_SERVER['HTTPS']='on';
#cityhost
define('DB_NAME', 'massagcours');
define('DB_USER', 'massagcours');
define('DB_PASSWORD', 'HBUFPxqAdw');
